...
```
```{r}
# create a unique list of commanders, splittind the commander col by comma

unique_commanders = uboats %>% dplyr::select("Notable Commanders") %>% distinct() %>% separate_rows("Notable Commanders", sep = ",")
unique_commanders
```