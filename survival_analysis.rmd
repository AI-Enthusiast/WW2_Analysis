...
models[[3]] = gen_model(top_5, 'notable + commish_year', "weibull", "Weibull:notable+commish_year")
models[[4]] = gen_model(top_5, "notable + Type +  commish_year", "weibull", "Weibull:notable+Type+commish_year")
models[[5]] = gen_model(top_5, "notable + Type +  commish_year + Type:commish_year", "weibull", "Weibull:notable+Type+Type*commish_year")

# lognormal models
models[[6]] = gen_model(top_5, "notable", "lognormal", "Lognormal:notable")
models[[7]] = gen_model(top_5, "notable + Type", "lognormal", "Lognormal:notable+Type")
models[[8]] = gen_model(top_5, 'notable + commish_year', "lognormal", "Lognormal:notable+commish_year")
models[[9]] = gen_model(top_5, "notable + Type +  commish_year", "lognormal", "Lognormal:notable+Type+commish_year")
models[[10]] = gen_model(top_5, "notable + Type +  commish_year + Type:commish_year", "lognormal", "Lognormal:notable+Type+Type*commish_year")

# exponential models
models[[11]] = gen_model(top_5, "notable", "exponential", "Exponential:notable")
models[[12]] = gen_model(top_5, "notable + Type", "exponential", "Exponential:notable+Type")
models[[13]] = gen_model(top_5, 'notable + commish_year', "exponential", "Exponential:notable+commish_year")
models[[14]] = gen_model(top_5, "notable + Type +  commish_year", "exponential", "Exponential:notable+Type+commish_year")
models[[15]] = gen_model(top_5, "notable + Type +  commish_year + Type:commish_year", "exponential", "Exponential:notable+Type+Type*commish_year")

# gompertz models
models[[16]] = gen_model(top_5, "notable", "gaussian", "gaussian:notable")
models[[17]] = gen_model(top_5, "notable + Type", "gaussian", "gaussian:notable+Type")
models[[18]] = gen_model(top_5, 'notable + commish_year', "gaussian", "gaussian:notable+commish_year")
models[[19]] = gen_model(top_5, "notable + Type +  commish_year", "gaussian", "gaussian:notable+Type+commish_year")
models[[20]] = gen_model(top_5, "notable + Type +  commish_year + Type:commish_year", "gaussian", "gaussian:notable+Type+Type*commish_year")
...
if (best_model$dist_name == best_rsq_model$dist_name) {
  ...
  print(best_rsq_model$aqi)
}
```
```{r}
# plot predicted vs actual
pred = predict(best_model$model, newdata = top_5, type = "response")
top_5 = top_5 %>% mutate(pred = pred)
top_5 %>% ggplot() +
